...
public class SuccinctDirectedGraphSpeedTest {
	...
	public static void main(final String args[]) throws IOException, ClassNotFoundException {
        ...
        SuccinctDirectedGraph succinct;
        final File succinctFile = new File(basename + ".suxdir");

        if (succinctFile.exists())
            succinct = (SuccinctDirectedGraph) BinIO.loadObject(succinctFile);
		else {
            succinct = new SuccinctDirectedGraph(sparse);
        ...
        final GraphIterables<Integer, IntIntPair> succinctIterables = succinct.iterables();
